...
ini_set('default_charset','UTF-8');
 include_once("ADMIN/PHP/FunctionsDB/User/CadastrarUser.php");
...
<main class="form-main">
  <form action="#" method="post">
    <h1>Cadastrar</h1>
    <div>
     <p><?php $Validado -> ValidaEmail($Email); ?></p> 
     <input type="email" placeholder="Email" require="true" name="Email">
    </div>
    <div>
     <p><?php $Validado -> ValidaSenha($Senha); ?></p> 
     <input type="password" placeholder="Senha" require="true" name="Senha">
    </div>
    <div>
      <p><?php $Validado -> ValidaNome($Nome); ?></p> 
     <input type="text" placeholder="Nome" require="true" name="Nome">
    </div>
     <input type="submit" value="Cadastrar">
     <?php 
          $Validado -> CadastroValidado(); 
